...
if($autorizacion==null||$autorizacion==""){
   ...
   <div class="items">
    ...
    while ($reg = mysqli_fetch_array($registros)) {
        ...
        <label>Email</label>
        <input type="text" placeholder="correo electrónico" name="email" value="'.$reg[3].'">
        <label>Encuesta_razon</label>
        <input type="text" placeholder="correo electrónico" name="email" value="'.$reg[4].'">
        <label>linkedin</label>
        <input type="text" placeholder="correo electrónico" name="email" value="'.$reg[5].'">
        </form>';
      }
    echo '</aside>';
}
